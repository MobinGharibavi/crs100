<template>
  ...
  >
    <div
      class="w-[21.25rem] h-full bg-white rounded-r-[2rem] rtl:rounded-l-[2rem] rtl:rounded-r-none flex flex-col justify-between"
    >
      <div>
        ...
        <ul class="mt-10 text-xl text-[#5B4A42] px-6 space-y-3">
          <li
            class="text-orange bg-orange-200 h-14 rounded-[0.75rem] flex gap-4 px-4 items-center cursor-pointer"
          >
            <svg
              class="h-14"
              width="24"
      ...
      <div class="flex flex-col">
        <div class="px-6">
          <div
            dir="rtl"
            class="flex p-1 h-[3rem] bg-[#F7F7F9] rounded-[0.5rem] min-w-[13.25rem] text-[#514037]"
          >
            <div
        ...
        <button class="flex py-4 justify-center font-semibold text-[#EE0035]">
          خروج از حساب کاربری
        </button>
      </div>
    </div>
