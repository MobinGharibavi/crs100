<template>
  <Body :class="{ 'overflow-hidden': sideMenu }">
    <div class="p-5 md:px-10 hidden lg:flex justify-between items-center">
      <NuxtLink
        :to="`/${locale}`"
        class="flex  text-3xl rtl:flex-row-reverse"
      >
        <span class="text-orange-500 font-km_bold">C</span>
        <p class="font-km_bold">rs</p>
        <span class="text-orange-500 font-km_bold">T</span>
        <p class="font-km_bold">rip</p>
        <span class="text-orange-500 font-km_bold">.</span>
      </NuxtLink>
