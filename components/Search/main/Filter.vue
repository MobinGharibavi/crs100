<template>
  <div
    class="flex items-center flex-col lg:flex-row justify-center gap-5 -mt-52 mb-10"
  >
    <div class="flex flex-col w-11/12 lg:w-auto gap-5">
      <div
        class="bg-white py-3 px-5 w-full lg:w-80 gap-2 rounded-lg flex flex-col"
      >
        <h3>{{ $t("search.main.search_flight.title") }}</h3>
            ...
            <TransitionExpand :duration="500">
              <div v-if="PassengerAir">
                <div class="flex items-center border-b p-2.5 justify-between">
                  ...
                  <div class="flex items-center gap-2">
                    <button
                      class="rounded-lg flex items-center justify-center p-2.5 text-white bg-orange-500"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="1em"
                    ...
                    <span>0</span>
                    <button
                      class="rounded-lg flex items-center justify-center p-2.5 text-white bg-orange-500 opacity-50"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="1em"
        ...
        <button
          ...
          class="bg-orange text-white rounded-xl flex items-center justify-center gap-1 font-semibold py-3"
        >
          <Icon name="ic:outline-search" />
          <span>{{ $t("search.main.search_flight.btn") }}</span>
        </button>
      </div>
